...
(function () {
        ...
        if ($mobileDropdown) {
          ...
          $mobileMenu && $mobileMenu.querySelectorAll(_this.selectors.mobileSubNavClose).forEach($btn => {
            $btn.addEventListener('click', function(event) {
              ...
              $btn.parentElement.parentElement.parentElement.classList.add(_this.selectors.mobileSubNavHiddenClass);
  ...
  class Uomo {
    ...
    initCookieConsient() {
      const purecookieDesc = "Size kişiselleştirilmiş bir alışveriş deneyimi sunmak için sitemiz çerez kullanmaktadır. Bu siteyi kullanmaya devam ederek çerez politikamızı kabul etmiş olursunuz.",
      purecookieButton = "Kabul Et";
