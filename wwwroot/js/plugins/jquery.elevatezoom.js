...
(function( $, window, document, undefined ) {
  var ElevateZoom = {
      init: function( options, elem ) {
        ...
        self./wwwroot/imagesrc = self.$elem.data("zoom-image") ? self.$elem.data("zoom-image") : self.$elem.attr("src");
        ...
        self.zoomImage = self./wwwroot/imagesrc;
      ...
      refresh: function( length ) {
        ...
        setTimeout(function() {
          self.fetch(self./wwwroot/imagesrc);
      ...
      fetch: function(imgsrc) {
        ...
        newImg.onload = function() {
          ...
          self.startZoom();
          self.currentImage = self./wwwroot/imagesrc;
      ...
      startZoom: function( ) {
        ...
        if(self.options.zoomType == "window") {
          ...
          // adjust /wwwroot/images less than the window height
        ...
        if(self.options.zoomType != "inner") {
          ...
          if(self.options.tint) {
            ...
            self.zoomTintImage = $('<img loading="lazy" style="position: absolute; left: 0px; top: 0px; max-width: none; width: '+self.nzWidth+'px; height: '+self.nzHeight+'px;" src="'+self./wwwroot/imagesrc+'">')
        ...
        if(self.options.zoomType == "lens") {
          self.zoomLens.css({ backgroundImage: "url('" + self./wwwroot/imagesrc + "')" }); 
        }
        if(self.options.zoomType == "window") {
          self.zoomWindow.css({ backgroundImage: "url('" + self./wwwroot/imagesrc + "')" }); 
        }
        if(self.options.zoomType == "inner") {
          self.zoomWindow.css({ backgroundImage: "url('" + self./wwwroot/imagesrc + "')" }); 
        }
...
//            and on mouseleave check if scrolllock          
      ...
      setWindowPostition: function( e ) {
        ...
        if(self.options.zoomType == "window" || self.options.zoomType == "inner") {
          ...
          if(self.zoomLock == 1){
            //overrides for /wwwroot/images not zoomable
      ...
      swaptheimage: function(smallimage, largeimage){
        ...
        self.options.on/wwwroot/imageswap(self.$elem);
      ...
      swapAction: function(smallimage, largeimage){
        ...
        newImg2.onload = function() {
          ...
          self.options.on/wwwroot/imageswapComplete(self.$elem);
...
//          calculate new width ratio
  ...
  $.fn.elevateZoom.options = {
      ...
      preloading: 1, //by default, load all the /wwwroot/images, if 0, then only load /wwwroot/images after activated (PLACEHOLDER FOR NEXT VERSION)
      ...
      on/wwwroot/imageswap: $.noop,
      on/wwwroot/imageswapComplete: $.noop
  };
